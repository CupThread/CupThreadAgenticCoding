...
| `/api/v1/public/versions/:appKey` | `GET` | Release versions sorted by position. Same `401` `authentication_required` (PRIV-12) on sign-in-only roadmaps as the columns route. |
